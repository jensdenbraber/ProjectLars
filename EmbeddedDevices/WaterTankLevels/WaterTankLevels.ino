/*
  ...
  It connects to the provided access point using dhcp, using ssid and password
...
{
  int sensorwaterTankLevel = analogRead(analogReadPin);
  return map(sensorwaterTankLevel, waterTankFullResistance, waterTankEmptyResistance, 0, 100);
}
